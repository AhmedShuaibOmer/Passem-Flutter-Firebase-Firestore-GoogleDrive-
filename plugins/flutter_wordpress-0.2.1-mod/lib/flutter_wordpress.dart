...
/// A Singleton Wrapper for the [WordPress] class.
class WordPressService extends WordPress {
  ...
  static WordPressService get instance {
    if (_instance == null) {
      _instance = WordPressService._internal();
    }
